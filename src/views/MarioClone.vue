  ...
  <div class="mission mission--feelit">
    <section class="mission__hero card surface-frosted">
      <div class="mission__hero-copy">
        ...
        <h1>Mario</h1>
        <p>Zorg dat Mario overleeft! Spring weg van de lava en kijk uit voor de Bullets van boven!!</p>
      </div>
    ...
    <section class="mission__panel card">
      ...
      <ul class="mission__list">
        <li><strong>1.</strong> Begeef je naar lokaal 2.08 en start de Mario-game.</li>
        <li><strong>2.</strong> Gebruik spatie om te springen.</li>
        <li><strong>3.</strong> Gebruik A en D om naar links en rechts te bewegen. Succes!!</li>
      </ul>
    </section>

    <section class="mission__panel card">
      <h2 class="section-heading">Hou Mario in leven!</h2>
...
export default {
  data() {
    return {
      ...
      router: useRouter(),
      heroImage: new URL('@/assets/game2/mario.png', import.meta.url).href
    };
  },
  ...
  methods: {
    async checkCode() {
      if (this.enteredCode.toUpperCase() === this.correctCode) {
        this.errorMessage = "";
        this.successMessage = "Goed gedaan agent! Mario heeft het overleefd!";
